...
const manifest = `{
  ...
  "rpcmethods": [
    {
      "name": "waitpay",
      "usage": "bolt11 [msatoshi] [riskfactor] [label] [maxfeepercent] [exemptfee] [maxdelaytotal]",
...
var waitpaykeys []string = []string{"bolt11", "msatoshi", "riskfactor", "label", "maxfeepercent", "exemptfee", "maxdelaytotal"}
